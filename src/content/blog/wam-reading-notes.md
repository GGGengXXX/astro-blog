---
title: 'WAM 读书笔记：持续更新中'
description: '把关于 WAM、DreamZero、FastWAM 等相关工作的理解整理成一篇会继续补充的笔记。'
pubDate: 'Jul 20 2026'
...
这篇笔记整理自我对 WAM 相关内容的阅读，先从 DreamZero、World Action Models: A Survey 和 FastWAM 开始，后面会持续补充更多相关工作。

我更想把它写成一份“读后梳理”，而不是论文复述。重点不是每个符号怎么推出来，而是这条路线到底在解决什么问题，以及它为什么会走到今天这一步。

这篇文章会持续更新，所以我会把暂时还没展开的内容单独放在后面，方便之后接着补。
...
目前从题目来看，它应该会和前面这几篇一起，继续讨论 WAM 里“如何更好地把世界建模和动作策略连接起来”这件事。等我把正文读完，会把这里补成更完整的一段。
